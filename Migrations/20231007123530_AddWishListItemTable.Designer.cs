...
namespace JWTRefreshTokenInDotNet6.Migrations
{
    ...
    [Migration("20231007123530_AddWishListItemTable")]
            ...
            modelBuilder.Entity("MyProject.Models.realstates.RealEState", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryIn")
            ...
            modelBuilder.Entity("MyProject.Models.realstates.RealEState", b =>
                {
                    b.HasOne("MyProject.Models.RealStates.Compound", "Compound")
                        .WithOne("ReaEState")
                        .HasForeignKey("MyProject.Models.realstates.RealEState", "CompoundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyProject.Models.realstates.RealEStateType", "PropertyType")
                        .WithMany("RealStates")
            ...
            modelBuilder.Entity("MyProject1.Models.RealStates.PaymentPlanForRealEState", b =>
                {
                    b.HasOne("MyProject.Models.realstates.RealEState", "RealEState")
                        .WithOne("Payment")
                        .HasForeignKey("MyProject1.Models.RealStates.PaymentPlanForRealEState", "RealEStateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
